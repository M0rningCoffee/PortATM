...
Partial Class Formsenhadeposito
    ...
    Private Sub InitializeComponent()
        ...
        Me.Controls.Add(Me.txt_senha_deposito)
        Me.Controls.Add(Me.btn_ClearSD)
        Me.Controls.Add(Me.btn_CancelSD)
        Me.Controls.Add(Me.Button0SD)
        Me.Controls.Add(Me.Button9SD)
        Me.Controls.Add(Me.Button8SD)
        Me.Controls.Add(Me.Button7SD)
        Me.Controls.Add(Me.Button6SD)
        Me.Controls.Add(Me.Button5SD)
        Me.Controls.Add(Me.Button4SD)
        Me.Controls.Add(Me.Button3SD)
        Me.Controls.Add(Me.Button2SD)
        Me.Controls.Add(Me.Button1SD)
